    ...
    >
      <div className="mx-auto w-full max-w-[var(--content-max-width)] text-center">
        ...
        <a
          ...
          className="mt-8 inline-block break-words font-sans text-sm uppercase tracking-widest text-ink underline-offset-4 opacity-60 transition-opacity duration-[var(--duration-fast)] hover:opacity-100"
        >
